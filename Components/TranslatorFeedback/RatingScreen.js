...
const RatingScreen = ({navigation}) => {
    ...
    const [nextScreen, setScreenPath] = useState('TrFeedback3');

    const ratingComplete = (rating) => {
        setRating(rating)
        if (rating >= 4) {
            setScreenPath('TrFeedback2')
        }
    }
    ...
    return (
        <View class="main-page-container" style={styles.container}>
            ...
            <View style={{alignItems:'center', top: -300}}>
                <Text style={styles.headerText}>Rate your experience with your requestor</Text>
                <Text style={styles.text}>Your requestor won't see this</Text>
