...
const PickingUpScreen = ({navigation}) => {
    const [show, setShow] = useState(false);

    return (
        <View class="main-page-container" style={styles.contianer}>
            <TouchableOpacity style={styles.backArrowContainer} onPress={() => {navigation.navigate('TrTutorial2')}}>
            ...
            <Image style={styles.img} source={require('../../assets/t-tutorial-3.png')} />
            ...
            <View style={styles.bottom}>
                ...
                <TouchableOpacity style={styles.nextBtn} onPress={() => {navigation.navigate('TrTutorial4')}}>
